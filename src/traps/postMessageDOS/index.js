...
export default new EvilTrap('postMessage DoS', EvilTrap.CATEGORY.DOS, 'High amounts of postMessage calls lead to memory exhaustion and may cause system instability.', { firefox: '1543318' })
  .addScriptPage(() => {
